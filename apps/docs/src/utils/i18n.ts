...
const th = {
	...
	developmentBanner:
		'<strong>โปรเจกต์นี้อยู่ในช่วงเริ่มต้นของการพัฒนา</strong> API และ Schema อาจมีการเปลี่ยนแปลงหลายครั้งก่อนเปิดตัวสู่สาธารณะอย่างเป็นทางการโดยไม่ได้แจ้งล่วงหน้า',
};
