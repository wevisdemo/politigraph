...
We intend to open Politigraph as a public database, allowing users, various projects and AI agents to utilize the data. We believe that effective open data fosters innovation, supports civic participation, and builds a strong democratic society. [Read how to use it](/en/getting-started/usage)
...
You can also visit [Explore](/en/explore) to browse the data in Politigraph without writing any code.
